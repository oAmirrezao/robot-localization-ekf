...
def generate_launch_description():
    ...
    prediction_node = Node(
        ...
        parameters=[
            ...
            {'prediction_topic': '/motion_model/odom'},
            {'process_noise_vx': 0.1},
            {'process_noise_wz': 0.1}
        ]
    )
    ...
    measurement_node = Node(
        ...
        parameters=[
            ...
            {'vo_topic': '/vo/odom'},
            {'measurement_topic': '/measurement/odom'},
            {'measurement_noise_dx': 0.05},
            {'measurement_noise_dy': 0.05},
            {'measurement_noise_theta': 0.1}
        ]
    )
    ...
    ekf_node = Node(
        ...
        parameters=[
            ...
            {'initial_y': 0.0},
            {'initial_theta': 0.0},
            {'initial_covariance_xx': 0.1},
            {'initial_covariance_yy': 0.1},
            {'initial_covariance_tt': 0.1}
        ]
    )
